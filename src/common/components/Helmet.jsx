...
const Helmet = ({
  ...
  const currentlocaleLang = getLocalePath().find((l) => l.slug === slug)?.lang;
  ...
  return (
    <Head>
      ...
      {translationsExists && (
        <link rel="canonical" href={`https://4geeks.com${currentlocaleLang !== 'en' ? `/${currentlocaleLang}` : ''}${canonicalPathConector || pathConnector}/${slug || translations?.[locale] || translations?.us || translations?.en}`} />
      )}
