...
const Helmet = ({
  ...
  return (
    <Head>
      ...
      {translationsExists && (
        <link rel="canonical" href={`https://4geeks.com${locale !== 'en' ? `/${locale}` : ''}${canonicalPathConector || pathConnector}/${translations?.[locale] || translations?.us || translations?.en}`} />
      )}
      ...
      <meta property="og:url" content={url.length > 0 ? `https://4geeks.com${locale !== 'en' ? `/${locale}` : ''}${url}` : 'https://4geeks.com'} />
