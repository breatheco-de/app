const liveEventOpaque = ({
  ...
  >
    ...
    <circle cx="30" cy="29.5" r="22" fill="#EB3323" fillOpacity="0.3" />
    ...
    <path d="M32.5 29.134C33.1667 29.5189 33.1667 30.4811 32.5 30.866L25.75 34.7631C25.0833 35.148 24.25 34.6669 24.25 33.8971L24.25 26.1029C24.25 25.3331 25.0833 24.852 25.75 25.2369L32.5 29.134Z" fill="#EB3323" fillOpacity="0.3" />
  </svg>
