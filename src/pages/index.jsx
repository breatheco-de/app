      ...
      <Grid gridTemplateColumns={{ base: 'repeat(1,1fr)', md: 'repeat(2,1fr)' }} height="100%">
        ...
        >
          <Box display="flex" width="auto" flexDirection="column" gridGap="10px">
            <Image src="/static/images/person-smile1.png" alt="person1" width={233} height={215} />
            <Image src="/static/images/person-smile3.png" alt="person2" style={{ borderRadius: '15px' }} width={233} height={247} />
          </Box>
          <Box display="flex" width="auto" flexDirection="column" gridGap="10px">
            <Image src="/static/images/person-smile2.png" alt="person3" width={233} height={247} />
            <Image src="/static/images/person-smile4.png" alt="person4" width={233} height={215} />
          </Box>
        </Box>
      </Grid>
    </Box>
