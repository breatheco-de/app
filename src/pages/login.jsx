      ...
      <Box align="center" alignContent="center" width="50%" marginTop="47px">
        ...
        <Tabs marginTop="67px">
          <TabList justifyContent="center" width="365px">
            <Tab
              _selected={{ color: 'gray.dark', bg: 'white', borderBottomColor: 'blue.default' }}
              color="gray.default"
          ...
          <TabPanels>
            <TabPanel>
              ...
              <Box display="flex" justifyContent="center" width="100%">
                <Box
                  ...
                  marginRight="13px"
                />
                <Box marginBottom="30px" marginTop="30px" color="gray.default">
                  or
                </Box>
                <Box
                  borderBottom="solid 1px #DADADA"
              ...
              <Box color="blue.default" fontWeight="700" align="center" marginLeft="245px">
                Reset Password
              </Box>
              <Button
                disabled="True"
            ...
            <TabPanel width="365px" padding="0px">
              <FormControl marginTop="22px">
                <Text color="gray.default" fontSize="sm" float="left" marginBottom="px">
                  Full Name
                  {' '}
                </Text>
                <Input
              ...
              <Button variant="default" marginTop="33px" width="365px" fontSize="l">
                REGISTER
              </Button>
            </TabPanel>
          </TabPanels>
