...
import { Box, Image, Text, Tag, Link, Flex, Input, InputGroup, InputLeftElement, InputRightElement, Button } from '@chakra-ui/react';
import { SearchIcon, ArrowRightIcon, CloseIcon, SettingsIcon } from '@chakra-ui/icons';
    ...
    <Box mb={10} ms={10} mx={10}>
      <Box bg="#EEF9FE" p={10} borderRadius="md" mt={4} mb={6}>
        ...
        <Flex justify="space-between" align="center" mt={4} w="100%">
          ...
          {/* Filter Button */}
          <Button leftIcon={<SettingsIcon />} mt={2} size="sm" colorScheme="blue">
            Filter
          </Button>
        </Flex>
        ...
        <Flex mt={2} gap={2} flexWrap="wrap">
          {tags.map((tag, index) => (
            <Tag key={index.id} size="md" colorScheme="blue" borderRadius="full" px={3}>
              {tag}
              {' '}
